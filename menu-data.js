...
const menuData = {
  cocktails: [
    ...
    { name: 'NEGRONI', desc: 'СУХИЙ ДЖИН / ЧЕРВОНИЙ ВЕРМУТ / БІТТЕР', volume: '200 мл', price: '230 ₴', img: '', strength: 3 },
  ...
  shots: [
    ...
    { name: 'ЗЕЛЕНИЙ МЕКСИКАНЕЦЬ', desc: 'ТЕКІЛА / ЛІКЕР ЗЕЛЕНИЙ БАНАН / ФРЕШ ЛАЙМА', volume: '50 мл', price: '120 ₴', img: '', strength: 3 },
