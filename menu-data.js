...
const menuData = {
  ...
  strongAlcohol: [
    { name: 'Ром Captain Morgan Spiced Gold', desc: '', volume: '50 мл', price: '90 ₴', img: 'img/captain_morgan_spiced.jpg', strength: 3 },
    { name: 'Ром Captain Morgan TIKI', desc: '', volume: '50 мл', price: '90 ₴', img: 'img/captain_morgan_tiki.jpg', strength: 3 },
    { name: 'Ром Oakheart Original 35%', desc: '', volume: '50 мл', price: '90 ₴', img: 'img/sa_oakheart.jpg', strength: 3 },
    { name: 'Ром Bacardi CartaBianca', desc: '', volume: '50 мл', price: '90 ₴', img: 'img/sa_bacardi.jpg', strength: 3 },
    { name: 'Текіла Sierra Blanko', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_sierra_blanco.jpg', strength: 3 },
    { name: 'Віскі Jameson', desc: '', volume: '50 мл', price: '120 ₴', img: 'img/sa_jameson.jpg', strength: 3 },
    { name: 'Віскі Jack Daniels', desc: '', volume: '50 мл', price: '120 ₴', img: 'img/sa_jackdaniels.jpg', strength: 3 },
    { name: 'Віскі Paddy', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_paddy.jpg', strength: 3 },
    { name: 'Бурбон Jim Beam White', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_jimbeam_white.jpg', strength: 3 },
    { name: 'Бурбон Jim Beam Red Stag', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_jimbeam_redstag.jpg', strength: 3 },
    { name: 'Джин Finsbury Platinum 47%', desc: '', volume: '50 мл', price: '90 ₴', img: 'img/sa_finsbury_platinum.jpg', strength: 3 },
    { name: 'Джин Finsbury Wild Strawberry', desc: '', volume: '50 мл', price: '90 ₴', img: 'img/sa_finsbury_strawberry.jpg', strength: 3 },
    { name: 'Лікер Jagermeister', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_jagermeister.jpg', strength: 3 },
    { name: 'Лікер Jagermeister Orange', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_jagermeister_orange.jpg', strength: 3 },
    { name: 'Настоянка Becherovka', desc: '', volume: '50 мл', price: '80 ₴', img: 'img/sa_becherovka.jpg', strength: 3 },
    { name: 'Лікер Baileys', desc: '', volume: '50 мл', price: '110 ₴', img: 'img/sa_baileys.jpg', strength: 1 },
    { name: 'Лікер SAMBUCA', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_sambuca.jpg', strength: 3 },
    { name: 'Абсент', desc: '', volume: '50 мл', price: '100 ₴', img: 'img/sa_absent.jpg', strength: 3 },
    { name: 'Бренді Couronnier Napoleon', desc: '', volume: '50 мл', price: '70 ₴', img: 'img/sa_couronnier.jpg', strength: 3 },
    { name: 'Горілка Nemiroff original', desc: '', volume: '50 мл', price: '40 ₴', img: 'img/sa_nemiroff.jpg', strength: 3 },
    { name: 'Вермут Martini Rosso', desc: '', volume: '50 мл', price: '70 ₴', img: 'img/sa_martini_rosso.jpg', strength: 1 },
    { name: 'Лікер Амаретто VillaCardea', desc: '', volume: '50 мл', price: '70 ₴', img: 'img/sa_villacardea.jpg', strength: 2 },
    { name: 'Лікер Вишневий SanMartino', desc: '', volume: '50 мл', price: '70 ₴', img: 'img/sa_sanmartino_cherry.jpg', strength: 2 },
    { name: 'Лікер Лімончелло SanMartino', desc: '', volume: '50 мл', price: '70 ₴', img: 'img/sa_sanmartino_limoncello.jpg', strength: 2 }
  ],
  nastoyanky: [
