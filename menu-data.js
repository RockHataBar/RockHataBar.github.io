...
const menuData = {
  cocktails: [
    { name: 'ДЖИН ТОНІК', desc: 'джин/ тонік/ лайм', volume: '150 мл', price: '120 ₴', img: '', strength: 1 },
    { name: 'NEGRONI', desc: 'СУХИЙ ДЖИН / ЧЕРВОНИЙ ВЕРМУТ / БІТТЕР', volume: '200 мл', price: '230 ₴', img: '', strength: 3, hit: true },
    { name: 'CHERRY IVANSON', desc: 'JIM BEAM RedStag / СИРОП ВИШНЯ / СІК ВИШНЯ / ЛИМОННИЙ ФРЕШ', volume: '150 мл', price: '180 ₴', img: '', strength: 2 },
    { name: 'ТЕКІЛА САНРАЙЗ', desc: 'ТЕКІЛА / АПЕЛЬСИНОВИЙ СІК / ГРЕНАДИН', volume: '150 мл', price: '150 ₴', img: '', strength: 1 },
    { name: 'СЕКС ON ЗЕ БІЧ', desc: 'ГОРІЛКА / ПЕРСИКОВИЙ ЛІКЕР / АПЕЛЬСИНОВИЙ СІК / СІК ЖУРАВЛИНИ', volume: '200 мл', price: '120 ₴', img: '', strength: 1 },
    { name: 'ROSO TONIC', desc: 'ЧЕРВОНИЙ ВЕРМУТ / ТОНІК / АПЕЛЬСИН', volume: '200 МЛ', price: '120 ₴', img: '', strength: 1 },
    { name: 'CUBA LIBRE', desc: 'ЗОЛОТИЙ РОМ/ COCA COLA/ ЛАЙМ', volume: '150 мл', price: '110 ₴', img: '', strength: 2 },
    { name: 'КРИВАВА МЕРІ', desc: 'ТОМАТНИЙ СІК/ ГОРІЛКА/ ТАБАСКО/ ВУСТРСЬКИЙ СОУС/ ЛАЙМ', volume: '150 мл', price: '120 ₴', img: '', strength: 1 },
    { name: 'СИНІЙ КАМІКАДЗЕ', desc: 'ГОРІЛКА/ ЛИМОННИЙ СІК/ BLUE CURASAO', volume: '150 мл', price: '100 ₴', img: '', strength: 2 },
    { name: 'АНАСТЕЙША', desc: 'БІЛИЙ РОМ/ SPRITE/ ЛИМОННИЙ СІК/ BLUE CERASAO', volume: '300 мл', price: '180 ₴', img: '', strength: 1 }
  ],
  shots: [
    { name: 'ПАН ІВАН', desc: 'ГОРІЛКА / ЛИМОННИЙ СІК / ГРЕНАДИН', volume: '50 мл', price: '50 ₴', img: '', strength: 3 },
    { name: 'ЗЕЛЕНИЙ МЕКСИКАНЕЦЬ', desc: 'ТЕКІЛА / ЛІКЕР ЗЕЛЕНИЙ БАНАН / ФРЕШ ЛАЙМА', volume: '50 мл', price: '120 ₴', img: '', strength: 3, hit: true },
    { name: 'ПРАПОР', desc: 'ГОРІЛКА / ЛІКЕР АПЕЛЬСИНОВИЙ', volume: '50 мл', price: '50 ₴', img: '', strength: 3 },
    { name: 'КАЙДАШ', desc: 'ГОРІЛКА / ТАБАСКО / ГРЕНАДИН', volume: '50 мл', price: '80 ₴', img: '', strength: 3 },
    { name: 'МЕРКУРІЙ', desc: 'САМБУКА / БЕЙЛІЗ / ГРЕНАДИН', volume: '50 мл', price: '100 ₴', img: '', strength: 2 },
    { name: 'ВЕРШКОВИЙ МАРЦИПАН', desc: 'БЕЙЛІЗ/ АМАРЕТТО', volume: '50 МЛ', price: '100 ₴', img: '', strength: 1 },
